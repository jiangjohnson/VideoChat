...
public class ActivityLogin extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //
       // QBSettings.getInstance().fastConfigInit("15538", "5ZqqH8MT58sPOzh", "PN9FKy5pcZJAXU2");
        QBSettings.getInstance().fastConfigInit(VideoChatApplication.APPLICATION_ID, VideoChatApplication.APPLICATION_KEY, VideoChatApplication.APPLICATION_SECRET);  
    }
